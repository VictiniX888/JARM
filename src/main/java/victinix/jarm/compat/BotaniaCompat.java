...
public class BotaniaCompat {
    ...
    public static void postInit() {
        ...
        BotaniaAPI.registerManaInfusionRecipe(new ItemStack(GameRegistry.findItem("AWWayofTime", "etherealSlate")), new ItemStack(GameRegistry.findItem("AWWayofTime", "demonicSlate")), 30000);
    }
}
